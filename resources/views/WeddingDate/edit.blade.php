...
<div class="m-auto w-4/8 py-24">
    <div class="text-center">
        <h1 class="text-5xl uppercase bold">Wedding Date Edit Page</h1>
    </div>
</div>

<div class="flex justify-center pt-20">
    <form action="/date/{{ $wedding_dates->id }}" method="POST">
        @csrf
        @method('PUT')
        <div class="block">
            <h2 class="text-center text-lg">{{ $wedding_dates->id }}</h2>
            <input type="text"
            value="{{ $wedding_dates->date }}"
